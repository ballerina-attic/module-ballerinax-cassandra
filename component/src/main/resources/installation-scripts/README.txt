...
This guide contains instructions to install the Cassandra Ballerina module into your Ballerina installation. This is a one-time task.
...
1. install.{sh/bat} - Installs the Cassandra module.
2. uninstall.{sh/bat} - Uninstalls the Cassandra module if installed already.
